    ...
    <div class="row body">
      <div class="bs-example" data-example-id="striped-table">
         ...
         <table class="table table-striped">
            ...
            <tbody>
            <?php 
              $query = mysqli_query($conn, "SELECT * FROM  `webcasts` WHERE `flag` = 'Archive' ORDER BY `datetime` DESC");
            ...
            ?>
               <tr><td align="center" colspan="6">There are no Archived Webcasts available.</td></tr>
            <?php
                  }
             ?>
            </tbody>
